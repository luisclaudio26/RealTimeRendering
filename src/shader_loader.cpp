...
const GLchar* ShaderLoader::load_code(const std::string& path)
{
	std::fstream file;
...
GLuint ShaderLoader::load_shader(const std::string& file, GLenum shaderType)
{
...
GLuint ShaderLoader::load(const std::string& path)
{
